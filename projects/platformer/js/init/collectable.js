(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.db, 200, 170, 6, 0.7);
        collectable.create(type.kennedi, 100, 160, 15, 20.1);
        collectable.create(type.db, 300, 150, 8, 0.7);
        collectable.create(type.max, 400, 140, 9, 0.7);
